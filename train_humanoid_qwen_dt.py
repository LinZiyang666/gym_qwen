...
def parse_args():
    ...
    parser.add_argument("--dataset_dir", default=".", help="Offline dataset directory fallback.")
    ...
    parser.add_argument("--embed_dim", type=int, default=2048, help="Transformer hidden size.")
    ...
    parser.add_argument("--mlp_ratio", type=float, default=5.4, help="Feed-forward expansion ratio.")
    ...
    parser.add_argument("--warmup_steps", type=int, default=10000, help="LR warmup steps.")
    parser.add_argument("--num_eval_episodes", type=int, default=10, help="Evaluation episodes per iteration.")
    parser.add_argument("--max_iters", type=int, default=20, help="Training iterations.")
    parser.add_argument("--num_steps_per_iter", type=int, default=10000, help="Gradient steps each iteration.")
